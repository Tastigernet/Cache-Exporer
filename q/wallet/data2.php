...
$coingecko = fetch_coingecko("https://api.coingecko.com/api/v3/coins/cache");
$cxcheusd = number_format($coingecko['market_data']['current_price']['usd'],2,".",",");
...
$cxchebtc = number_format(($coingecko['market_data']['current_price']['btc'])*100000000,0,".",",");
$cxcheeur = number_format($coingecko['market_data']['current_price']['eur'],2,".",",");
...
print_r($cxchebtc." ".$cxcheusd." ".$btc." ".$marketcap." ".$totalvolume." ".$ccxeur." ".$btceur." ".$marketcapeur." ".$totalvolumeeur);
